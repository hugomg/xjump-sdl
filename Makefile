...
all: xjump doc/xjump.6.gz

clean:
	rm -rf ./*.o xjump config.h doc/xjump.6.gz
...
install:
	...
	$(INSTALL_DATA) -D doc/xjump.6.gz            $(DESTDIR)$(datadir)/man/man6/xjump.6.gz
